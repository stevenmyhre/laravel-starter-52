...
if (!function_exists('sql_view')) {
    function sql_view($name, $alias = 'X') {
        $path = app_path() . '/DOMAIN/SqlViews/' . $name . '.sql';
        if(!file_exists($path)) {
            throw new \InvalidArgumentException("View file " . $path . " could not be found.");
        }
